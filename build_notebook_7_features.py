"""Build notebooks_7/01_geometric_features.ipynb"""
import json
...
cells.append(md(
    ...
    "5. 4H macro context\n\n"
    "**Target:** `label_1H = log(close[t+1] / close[t])` — next 1H log return\n\n"
...
# ── Cell 2 — Section: Feature functions ───────────────────────────────────────
cells.append(md(
...
# ── Cell 7 — Layer 5: 4H macro context ───────────────────────────────────────
cells.append(code(
...
# ── Cell 8 — Section: Master pipeline ────────────────────────────────────────
cells.append(md(
...
# ── Cell 9 — Section: Run computation ────────────────────────────────────────
cells.append(md(
...
# ── Cell 10 — Section: Combine & labels ──────────────────────────────────────
cells.append(md("## 4. Combine & Save All Pairs"))
...
out_path = r"C:\Users\noual\lumeny\notebooks_7\01_geometric_features.ipynb"
