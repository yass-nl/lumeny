...
# Realistic spreads in POINTS (TradeLocker liquid-hours, Thu 15:30 UTC)
SPREAD_POINTS = {
...
# At 21:00-23:00 UTC (Sunday open / NY close), crosses widen significantly
# Majors stay roughly the same
...
# ── Slippage model ──
# Base slippage in points (liquid hours) — entry + exit combined
# Majors: very tight books, minimal slippage
# Crosses: thinner books, more slippage especially JPY crosses
        ...
        if hour in signal_index:
            ...
            for _, sig in hour_signals.iterrows():
                ...
                open_positions.append({
                    ...
                    'open_at': hour,
                    'close_at': hour + pd.Timedelta(hours=4),
                    'meta_proba': meta_p,
                    'q50': q50,
