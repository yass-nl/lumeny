...
# Cell 4 - define drops markdown
cells.append({
    "cell_type": "markdown", "metadata": {},
    "source": "## Step 1 \u2014 Define columns to drop"
})

# Cell 5 - define drops code
cells.append({
    "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
    "source": (
...
# Cell 6 - verify markdown
cells.append({
    "cell_type": "markdown", "metadata": {},
    "source": "## Step 2 \u2014 Verify on EURUSD before running"
})
...
# Cell 8 - clean markdown
cells.append({
    "cell_type": "markdown", "metadata": {},
    "source": "## Step 3 \u2014 Clean all pairs"
})
...
# Cell 10 - verify output markdown
cells.append({
    "cell_type": "markdown", "metadata": {},
    "source": "## Step 4 \u2014 Verify output"
})

# Cell 11 - verify output code
cells.append({
    "cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [],
    "source": (
...
with open('notebooks_cleanup/01_clean_features_6.ipynb', 'w', encoding='utf-8') as f:
