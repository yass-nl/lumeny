"""
Live Backtest — Test Q50 + Meta-Confidence Model on Recent Market Data

Fetches the last ~5 weeks of 1-minute data from Polygon.io,
...
META_DIR   = Path('backend/models_5/meta')
...
def compute_features_for_pair(pair, data):
    ...
    # label_1H = log return from this hour's close to next hour's close
